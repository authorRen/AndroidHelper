...
public final class FragmentManager {
    ...
    public static Fragment addFragment(@NonNull final android.support.v4.app.FragmentManager fragmentManager,
        ...
        putArgs(fragment, new Args(containerId, isHide, isAddStack));
        return operateFragment(fragmentManager, null, fragment, TYPE_ADD_FRAGMENT, sharedElements);
    }
    ...
    public static Fragment hideAddFragment(@NonNull final android.support.v4.app.FragmentManager fragmentManager,
        ...
        return operateFragment(fragmentManager, hideFragment, addFragment, TYPE_HIDE_ADD_FRAGMENT, sharedElements);
    }
     ...
     * @return destFragment
     */
    private static Fragment operateFragment(@NonNull android.support.v4.app.FragmentManager fragmentManager,
    ...
    public static Fragment getLastAddFragment(@NonNull final android.support.v4.app.FragmentManager fragmentManager) {
        return getLastAddFragmentInStack(fragmentManager, false);
    }
     ...
     * @return  最后加入的fragment
     */
    private static Fragment getLastAddFragmentInStack(android.support.v4.app.FragmentManager fragmentManager) {
        return getLastAddFragmentInStack(fragmentManager, true);
    }
     ...
     */
    private static Fragment getLastAddFragmentInStack(android.support.v4.app.FragmentManager fragmentManager, boolean isInStack) {
        List<Fragment> fragments = getFragments(fragmentManager);
     ...
     *
     * @param fragmentManager fragment管理器
     * @return 栈中顶层可见的fragment
     */
    public static Fragment getTopShowFragmentIsInStack(@NonNull final android.support.v4.app.FragmentManager fragmentManager) {
     ...
     */
    private static Fragment getTopShowFragmentIsInStack(android.support.v4.app.FragmentManager fragmentManager,
     ...
     */
    public static List<Fragment> getFragments(@NonNull android.support.v4.app.FragmentManager fragmentManager) {
        return getFragmentsInStack(fragmentManager, false);
    }
     ...
     */
    private static List<Fragment> getFragmentsInStack(@NonNull android.support.v4.app.FragmentManager fragmentManager) {
        return getFragmentsInStack(fragmentManager, true);
    }
     ...
     *
     * @param fragmentManager fragment管理器
     * @param isInStack       是否是栈中
     * @return  栈中同级别fragment
     */
    private static List<Fragment> getFragmentsInStack(@NonNull final android.support.v4.app.FragmentManager fragmentManager,
                                                     final boolean isInStack) {
     ...
     * @return  所有fragment
     */
    private static List<FragmentNode> getAllFragmentsIsInStack(android.support.v4.app.FragmentManager fragmentManager) {
     ...
     *
     * @param fragmentManager fragment管理器
     * @param fragmentNodes   结果
     * @param isInStack       是否是栈中的
     * @return 栈中所有fragment
     */
    private static List<FragmentNode> getAllFragmentsIsInStack(android.support.v4.app.FragmentManager fragmentManager,
                                                               ArrayList<FragmentNode> fragmentNodes,
                                                               boolean isInStack) {
        List<Fragment> fragments = fragmentManager.getFragments();
        if (fragments.isEmpty()) return Collections.emptyList();
        for (int i = fragments.size() - 1; i >= 0 ; --i) {
            ...
            if (fragment != null) {
                if (isInStack) {
                    if (fragment.getArguments().getBoolean(ARGS_IS_ADD_STACK)) {
                        fragmentNodes.add(new FragmentNode(fragment, getAllFragmentsIsInStack(fragment.getChildFragmentManager(), new ArrayList<FragmentNode>(), true)));
                    } else {
                        fragmentNodes.add(new FragmentNode(fragment, getAllFragmentsIsInStack(fragment.getChildFragmentManager(), new ArrayList<FragmentNode>(), false)));
                    }
                }
            }
        }
     ...
     * @return 是否消费回退事件
     */
    private static boolean dispatchBackPress(android.support.v4.app.FragmentManager fragmentManager) {
        List<Fragment> fragments = fragmentManager.getFragments();
    ...
    static class Args {
        ...
        public Args(final int id, final boolean isHide, final boolean isAddStack) {
            this.id = id;
            this.isHide = isHide;
